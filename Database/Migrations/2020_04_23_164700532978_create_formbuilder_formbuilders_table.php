...
class CreateFormbuilderFormbuildersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::dropIfExists('formbuilder__form_submit_data');
        Schema::dropIfExists('formbuilder__form_submits');
        Schema::dropIfExists('formbuilder__form_mail');
        Schema::dropIfExists('formbuilder__form_messages');
        Schema::dropIfExists('formbuilder__form_contents');
        Schema::dropIfExists('formbuilder__forms');
    }
}
